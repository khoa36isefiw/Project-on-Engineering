...
function CustomSuggestCollection() {
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Button sx={{ mr: '-12px', zIndex: 1, height: '40px', mt: '-5%', color: '#9d3030' }} onClick={handleGoToPrevImage}>
            ...
            <Button sx={{ ml: '10px', height: '40px', mt: '-5%', color: '#9d3030' }} onClick={handleGoToNextImage}>
