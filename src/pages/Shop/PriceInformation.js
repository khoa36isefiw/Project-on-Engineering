...
function PriceInformation() {
    ...
    const prices = ['Dưới 1,000,000đ', '1,000,000đ - 2,000,000đ', '2,000,000đ - 3,000,000đ', 'Trên 3,000,000đ'];
    ...
    return (
        ...
        >
            <ListItemButton onClick={handleClick} >
                ...
                <ListItemText primary={<CustomTypography sx={{fontWeight:'bold'}}>Giá Sản Phẩm</CustomTypography>} />
                    ...
                    {prices.map((price, index) => (
                        ...
                        >
                            ...
                            <ListItemText
                                ...
                                primary={
                                    <CustomTypography sx={{fontSize: '14px'}} variant="body1">{price}</CustomTypography>
                                }
                            />
                        </ListItemButton>
                    ))}
