...
export  const rowsTest = [
    createData(
        ...
        <Box>
            <CustomTypography  fontSize='14px'>Gimme Shoes</CustomTypography>
            <CustomTypography  fontSize='14px'>SKU: UTE S1</CustomTypography>
            <CustomTypography fontSize='14px'>Size : 41, Color : Orange Black</CustomTypography>
        </Box>,
        ...
        <CustomTypography fontSize='16px' variant="body1">80</CustomTypography>,
        // icon remove product
